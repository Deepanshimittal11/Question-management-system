    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-2.5 rounded-lg bg-slate-700 border border-slate-600 text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          required
        />
      </div>
      <div>
        ...
        <select
          ...
          className="w-full px-4 py-2.5 rounded-lg bg-slate-700 border border-slate-600 text-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500"
        >
          {topics.map((t) => (
      ...
      {(subTopics[selectedTopic]?.length ?? 0) > 0 && (
        <div>
          <label className="block text-sm font-medium text-slate-300 mb-1">Sub-topic (optional)</label>
          <select
      ...
      <div>
        <label className="block text-sm font-medium text-slate-300 mb-1">Problem URL</label>
        <input
          type="url"
          value={problemUrl}
      ...
      <div>
        <label className="block text-sm font-medium text-slate-300 mb-1">Resource / Video URL</label>
        <input
          type="url"
          value={resource}
